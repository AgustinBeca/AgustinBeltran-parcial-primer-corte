...
const service = new (0, _serviceDefault.default)("https://rickandmortyapi.com/api/character");
...
function createCharacterList() {
    ...
    service.getAllCharacters().then((personajes)=>{
        personajes.forEach((personaje)=>{
            //console.log(personaje);
            characterList.innerHTML = characterList.innerHTML + createCharacterCard(personaje);
        });
...
function createCharacterCard(character) {
    var color = "";
    if (character.status === "Alive") color = "#54CB44";
    else if (character.status === "unknown") color = "#9E9E9E;";
    else if (character.status === "Dead") color = "#D63D2E;";
